                      ...
                      <div className="row">
                          <div className="col-md-4 bg-c-lite-green user-profile">
                              <div className="card-block text-center text-white">
                                  ...
                                  <h3 style={{fontSize:'2.2rem'}}>{adminInfo.name}</h3>
                                  <p style={{fontSize:'1.5rem'}}>{adminInfo.id}</p> 
                              </div>
                          </div>
                              ...
                              <div className="card-block m-b-40">
                                  ...
                                  <div className="row">
                                      <div className="col-sm-6 m-b-40">
                                          ...
                                          <h6 style={{fontSize:'1.5rem'}}>{adminInfo.phone}</h6>
                                      </div>
                                      <div className="col-sm-6 m-b-40">
                                          <p style={{fontSize:'1.7rem', fontWeight:'bold'}}>Email</p>
                                          <h6 style={{fontSize:'1.5rem'}}>{adminInfo.email}</h6>
                                      </div>
                                      <div className="col-sm-12 m-b-40">
                                          <p style={{fontSize:'1.7rem', fontWeight:'bold'}}>Address</p>
                                          <h6 style={{fontSize:'1.5rem'}}>{adminInfo.address}</h6>
                                      </div>                                      
                                  </div>                                  
                              </div>
                          </div>
